<header class="max-w-5xl mx-auto mt-5 text-center">
    <h1 class="text-xl">

        Where street <span class="text-blue-500">food rules, the history is rich, and breathtaking landscapes</span> are
